      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li class="dropdown"><a href="gallery" class="active"><span>Gallery</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              <li><a href="gallery" class="active">Nature</a></li>
              <li><a href="gallery" class="active">People</a></li>
              <li><a href="gallery" class="active">Architecture</a></li>
              <li><a href="gallery" class="active">Animals</a></li>
              <li><a href="gallery" class="active">Sports</a></li>
              <li><a href="gallery" class="active">Travel</a></li>
